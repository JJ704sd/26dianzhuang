...
int main(void)
{
    ...
    require(timer_measurement_is_fresh(2000U, 500U, 1500U, 1U) != 0U,
            "timeout boundary must remain valid");
    require(timer_measurement_is_fresh(2001U, 500U, 1500U, 1U) == 0U,
            "stale measurement must expire");
    require(timer_measurement_is_fresh(5U, 0xFFFFFFF0U, 1500U, 1U) != 0U,
            "freshness must survive millisecond counter wrap");
    require(timer_measurement_is_fresh(10U, 10U, 1500U, 0U) == 0U,
